...
#json_base = "{ 'client_id_imgur' : '{}', 'client_secret_imgur' : '{}', 'tw_consumer_key' : '{}', 'tw_consumer_secret' : '{}', 'access_token' : '{}', 'access_secret' : '{}'}".format(imgur_id, imgur_secret, consumerkey, consumersecret, access, access_secret)
